...
#weight plate appearances
hitters2$weight <- hitters2$pa / mean(hitters2$pa) * max(hitters2$avg_z) - max(hitters2$avg_z)
#add to z_tot
hitters2$z_tot <- hitters2$z_tot + hitters2$weight
...
#penalize starters for no saves
starters1$weight <- -2.4
#add to z_tot
starters1$z_tot <- starters1$z_tot + starters1$weight
...
#penalize relievers for lack of innings and lack of wins
relievers1$weight <- -1.9 + 2 * (.4*2.7 - 2.7)
#add to z_tot
relievers1$z_tot <- relievers1$z_tot + relievers1$weight
